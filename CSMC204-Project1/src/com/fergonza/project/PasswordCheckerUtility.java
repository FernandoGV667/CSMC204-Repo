...
/**
 * Validates that a string is valid or not as a password. This utility class will be used to verify
 * the different requirements that a string requires to be valid and to be safe.
 * 
...
public class PasswordCheckerUtility {
   ...
   *  alphabetic character, has at least on lower-case alphabetic character, and has no more than 
   *  two of the same character in a row. 
   * 
  ...
  public static boolean isValidPassword(String passwordString) throws LengthException,
    ...
    return isLongEnough(passwordString) && hasUpperCase(passwordString)
        ...
        && hasValidSequence(passwordString);
  }
